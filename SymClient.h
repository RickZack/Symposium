...
public:
    ...
    virtual document openNewSource(const std::string& path, const std::string& name, privilege reqPriv, const std::string& destPath);
     ...
     */
    virtual privilege editPrivilege(const user& targetUser, const std::string& resPath, const std::string& resName, privilege newPrivilege, bool msgRcv);
     ...
     * again this function to actually perform the changing if the outcome is positive.
     */
    virtual  std::shared_ptr<filesystem> renameResource(const std::string& resPath, const std::string& resName, const std::string& newName, bool msgRcv);
     ...
     * again this function to actually perform the changing if the outcome is positive.
     */
    virtual std::shared_ptr<filesystem> removeResource(const std::string& resPath, const std::string& resName, bool msgRcv);
    std::string printDir();
